    ...
    <div>
      ...
      <div className='section-1 flex justify-around items-center px-52 mt-36 sm:flex-col md:flex-col lg:flex-row '>
        <div className='section-1-left lg:w-[70%] lg:h-[60%] lg:mr-5 flex flex-col justify-center md:w-[85vw] md:h-[60%] md:ml-5 sm:w-[85vw] sm:h-[60%] sm:ml-5'>
          <div className=' rounded-2xl bg-gray-100 w-[100px] h-[30px] text-center text-sm font-normal mb-5 flex items-center justify-center font-jakarta md:ml-[35vw]'>Gantt Charts</div>
          <div>
          ...
          <div className=' flex lg:justify-between md:ml-[15vw] sm:ml-[15vw] lg:items-center md:justify-between md:items-center sm:justify-between sm:items-center lg:w-[70%] mb-3 md:w-[50vw] sm:w-[50vw]'><button className='rounded-lg bg-gradient-to-r from-indigo-400 to-cyan-400 lg:w-[250px] lg:h-[40px] md:w-[250px] md:h-[40px] sm:w-[250px] sm:h-[40px] text-white font-medium text-lg font-jakarta '>Get Started</button>
         ...
         <div className=' flex justify-between items-center lg:w-[80%] md:w-[50%] sm:w-[60%] md:ml-[15vw] sm:ml-[15vw] md:mb-10 sm:mb-10'> <span className=' md:text-xs sm:text-xs'>⭐ ⭐ ⭐ ⭐ ⭐</span><p className=' font-jakarta text-cyan-400 flex lg:w-[20vw] md:w-[25vw] sm:w-[25vw] md:text-xs sm:text-xs md:items-center sm:items-center' >25,000+ reviews <img src="https://tse4.mm.bing.net/th?id=OIP.jHQLwTvVoKGcJNKN_5jL3QHaHa&pid=Api&P=0&h=180" alt="images" className=' lg:w-[20px] lg:h-[20px] ml-3 md:w-[15px] md:h-[15px] sm:w-[15px] sm:h-[15px]'/>
         <img src="https://clipart.info/images/ccovers/1522453412Logo-Snapchat-Png.png" alt="images" className=' lg:w-[20px] lg:h-[20px] mx-3 md:w-[15px] md:h-[15px] sm:w-[15px] sm:h-[15px]'/><img src="https://tse1.mm.bing.net/th?id=OIP.EhTMbGiYfYzQnWLgjZaoJAHaHa&pid=Api&P=0&h=180" alt="images" className=' lg:w-[20px] lg:h-[20px] md:w-[15px] md:h-[15px] sm:w-[15px] sm:h-[15px]'/></p></div>
...
<div className='brand-promotion flex justify-between items-center my-24 px-52'>
  ...
  <img src="https://logos-world.net/wp-content/uploads/2020/11/Logitech-Symbol.png" alt="brandImage" className=' w-[100px] h-[50px]'/>
      ...
      <div className='section-2 flex justify-between items-center px-36 mb-28'>
          ...
          <div className='flex justify-between flex-col w-[20vw] h-[45vh] p-4 mr-80'> 
...
<div className='last-section w-[80vw] flex flex-col justify-center items-center mb-24'>
  <div className=' w-[100px] h-[30px] bg-slate-300 rounded-xl text-center mb-5 font-normal font-jakarta flex justify-center items-center'>Gantt Charts</div>
